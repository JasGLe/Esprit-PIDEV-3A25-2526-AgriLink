...
use App\Form\UserManagement\ForgotPasswordType;
...
class PasswordResetController extends AbstractController
{
    ...
    public function forgotPassword(Request $request): Response
    {
        ...
        return $this->render('user_management/security/forgot_password.html.twig', [
            'form' => $form,
        ]);
    }
    ...
    public function passwordResetSent(): Response
    {
        ...
        return $this->render('user_management/security/password_reset_sent.html.twig');
    }
    ...
    public function resetPassword(Request $request, string $token): Response
    {
        ...
        return $this->render('user_management/security/reset_password.html.twig', [
            'form' => $form,
            'token' => $token,
        ]);
    }
